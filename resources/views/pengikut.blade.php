...
@section('isi')
    ...
    <div class="container-fluid px-4">
        ...
        <i class="breadcrumb-item active">Tentukan pengikut izin</i>
        <div class="row">
            <div class="col-md-12">
                @if ($izinTersimpan == '')
                    <i style="color : rgb(255, 0, 0);"><i class="fa fa-fa-warning"></i>データが見つかりません!</i>
                @else
                    {{ $izinTersimpan->id_jenis_izin }}
                    <form action="#" method="post" class="f1">
                        ...
                        <fieldset>
                            <div class="form-group">
                                <h4>Santri Pengikut izin</h4>
                                <label>Nama Santri (Terpilih otomatis)</label>
                                <input style="width:75%" type="text" name="tanggal_izin" class="form-control">
                                <br>
                            </div>
                            <div class="row">
                                <label>Tambah santri pengikut izin</label>
                                <div class="col-md-5">
                            ...
                            <div class="f1-buttons">
                                <a href="/perizinan/jadwal_izin/{{ $izinTersimpan->id_izin }}" type="button" class="btn btn-danger btn-previous"> <i
